...
def responder(
    ...
    **atualizacoes: Any,  # noqa: ANN401 - campos do AtendimentoState
    ...
    Com `goto`, o comando salta para outro nó do grafo pai — é como o handoff continua a
    execução em vez de encerrar o turno.
    """
    ...
    return Command(goto=goto, graph=Command.PARENT, update=update)
